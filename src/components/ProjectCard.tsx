  ...
  return (
    <Link
      ...
      className="group relative overflow-hidden rounded-xl border border-zinc-200 
        ...
        dark:hover:border-zinc-200/50 dark:hover:bg-zinc-800/10 md:gap-8"
    >
      <article className="p-4 md:p-8">
        <h2
          className="z-20 text-xl font-medium text-zinc-800 
          group-hover:text-black dark:text-zinc-200 dark:group-hover:text-white lg:text-3xl
          "
        >
          {title}
        </h2>
